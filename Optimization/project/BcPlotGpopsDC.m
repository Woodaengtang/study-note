...
xline(0, "k"); yline(0, "k");
legend([xyGPOPS, xyDcol], {"GPOPS", "Direct Collocation"}, "Location", "southwest", "Interpreter", "latex");
...
legend([GpopsJ, DcolJ], {"GPOPS", "Direct Collocation"}, "Location", "southwest", "Interpreter", "latex");
